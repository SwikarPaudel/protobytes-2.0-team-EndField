...
DIFFICULTY_MAP = {"easy": 1, "medium": 2, "hard": 3, "expert": 4, "legendary": 5}
...
async def evaluate_submission(
    ...
    actual_0 = first_result.stdout.replace('\r\n', '\n').strip()
    expected_0 = first_tc.expected_output.replace('\r\n', '\n').strip()
    ...
    damage = int(challenge.base_damage * pass_ratio)

    diff_level = DIFFICULTY_MAP.get(challenge.difficulty.lower(), 1)
    difficulty_multiplier = 1.0 + (diff_level - 1) * 0.15
